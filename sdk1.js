/*1748458709,,JIT Construction: v1023249347,fr_FR*/
                ...
                (function(a) {
                    ...
                    function k(e, h) {
                        ...
                        if (h.resolved)
                            return h;
                        e = h.special;
                        var i = h.factory.length, k = e & f ? d.concat(h.deps) : c.concat(h.deps), o = [], p;
                        for (var q = 0; q < i; q++) {
                            switch (k[q]) {
                            case "module":
                                p = h;
                    ...
                    function l(a, b) {
                        a = k(a, b);
                        if (a)
                            return a.defaultExport !== i ? a.defaultExport : a.exports
                    }
                    function m(a) {
                        a = k(a);
                        if (a)
                            return a.defaultExport !== i ? a.defaultExport : null
                    }
                    function n(a) {
                        a = k(a);
                        if (a)
 ...
 */
                ...
                __d("JSSDKRuntimeConfig", [], {
                    ...
                    "sdkab": null,
                    "sdkns": "",
                    "sdkurl": "https:\/\/connect.facebook.net\/fr_FR\/sdk.js",
                    ...
                    var n = c("Type").extend({
                      ...
                      , o = {
                        ...
                        _createMobileLoader: function() {
                            var a = document.createElement("div");
                            c("sdk.UA").nativeApp() ? a.innerHTML = '<div class="dialog_header"></div>' : o.isTabletStyle() ? a.innerHTML = '<div class="overlayLoader"><div id="fb_dialog_loader_spinner"></div><a id="fb_dialog_loader_close" href="#">' + c("sdk.fbt")._(/*BTDS*/
                            "Annuler") + "</a></div>" : a.innerHTML = '<div class="dialog_header"><table>  <tbody>    <tr>      <td class="header_left">        <label class="touchable_button">          <input type="submit" value="' + c("sdk.fbt")._(/*BTDS*/
                            "Annuler") + '"            id="fb_dialog_loader_close"/>        </label>      </td>      <td class="header_center">        <div>         ' + c("sdk.fbt")._(/*BTDS*/
                            "Chargement\u2026") + '        </div>      </td>      <td class="header_right">      </td>    </tr>  </tbody></table></div>';
                            return o.create({
                        ...
                        iframe: function(a) {
                            ...
                            var b = function() {
                                var b = ES("JSON", "stringify", !1, {
                                    error_code: 4201,
                                    error_message: c("sdk.fbt")._(/*BTDS*/
                ...
                __d("sdk.SharedStringConstants", ["sdk.fbt"], (function(a, b, c, d, e, f, g) {
                    "use strict";
                    b = {
                        continueWith: (a = c("sdk.fbt"))._(/*BTDS*/
                        "Continuer avec {facebook_app_name} ou {instagram_app_name}"),
                        continueWithShort: a._(/*BTDS*/
                        "{facebook_app_name} ou {instagram_app_name}"),
                        loginButtonAriaLabel: a._(/*BTDS*/
                        "Continuer avec Facebook ou Instagram"),
                        logout: a._(/*BTDS*/
                        "D\u00e9connexion"),
                        logoutButtonAriaLabel: a._(/*BTDS*/
                        "Se d\u00e9connecter du site web actuel"),
                        titleText: a._(/*BTDS*/
                        "Choisir un compte"),
                        promptText: a._(/*BTDS*/
                        "Quel compte voulez-vous utiliser pour vous connecter\u00a0?"),
                        facebookText: a._(/*BTDS*/
                        "Se connecter avec Facebook"),
                        facebookTextShort: a._(/*BTDS*/
                        "Se connecter"),
                        instagramText: a._(/*BTDS*/
                        "Se connecter avec Instagram"),
                        disambiguationDialogAriaLabelText: a._(/*BTDS*/
                        "Log in with Facebook or Instagram"),
                        fbButtonText: a._(/*BTDS*/
                        "Continuer avec Facebook"),
                        igButtonText: a._(/*BTDS*/
                ...
                __d("sdk.MBasicInitializer", ["UrlMap", "sdk.DOM", "sdk.Runtime", "sdk.UA", "sdk.URI", "sdk.fbt"], (function(a, b, c, d, e, f, g) {
                    var h = function() {
                        function a(a) {
                            ...
                            e.textContent = c("sdk.fbt")._(/*BTDS*/
    ...
    __fb_i.src = 'https://www.facebook.com/platform/scribe_endpoint.php/?c=jssdk_error&m=' + encodeURIComponent('{"error":"LOAD", "extra": {"name":"' + __fb_err.name + '","line":"' + (__fb_err.lineNumber || __fb_err.line) + '","script":"' + (__fb_err.fileName || __fb_err.sourceURL || __fb_err.script || "sdk.js") + '","stack":"' + (__fb_err.stackTrace || __fb_err.stack) + '","revision":"1023249347","namespace":"FB","message":"' + __fb_err.message + '"}}');
